        ...
        >
          <Page size="A4" style={stilos_paleta.pagina}>
            <View style={stilos_paleta.seccion}>
              ...
              <Text style={stilos_paleta.item}>
                {user_data.bloques.Informacion_Personal[
                  documento.datos.Informacion_Personal
                ].Mostrar_Puesto
                  ? "Para el puesto: " +
                    user_data.bloques.Informacion_Personal[
                      documento.datos.Informacion_Personal
              ...
              <Text style={stilos_paleta.item}>Correo: {user_data.email}</Text>
              <Text style={stilos_paleta.item}>
                Teléfono:{" "}
                {
                  user_data.bloques.Informacion_Personal[
            ...
            {Object.keys(documento.diseno.Secciones.Orden).map((seccion) =>
              documento.diseno.Secciones[
                documento.diseno.Secciones.Orden[seccion]
              ].Mostrar ? (
                <View style={stilos_paleta.seccion}>
                  <Text>
                    {
          ...
          <div style={{ height: "1000px" }}>
            <div id="Herramientas" style={toolBar}>
              ...
              <span style={{ color: "white" }}>
                Por ahora, la plantilla simple es la utilizada
              </span>
            </div>
            <div
              id="overlay"
            ...
            ></div>
            <PDFViewer
              style={{ minWidth: "22cm", height: "100%" }}
              showToolbar={false}
            >
              <MyDocument />
            </PDFViewer>
