...
function EducacionTecnica({ user_data, setUserData, manager_bloques,category_manager }) {
    ...
    if (!user_data) {
        ...
        user_data.bloques.Educacion_Tecnica = user_data.bloques.Educacion_Tecnica
        ? user_data.bloques.Educacion_Tecnica
        : {};
    ...
    const bloque = manager_bloques.InsertarBloque(user_data, setUserData, "Educacion_Tecnica", {
        Fecha_Inicio: fecha_inicio,
        Fecha_Final: fecha_final,
        Programa: programa,
        Institucion: institucion,
    ...
    return (
        <>
          <div>
            <h1 style={{ color: "white", fontSize: "5rem" }}>Educación Tecnica</h1>
          </div>
              ...
              <div>
                <Paper style={paperStyle} sx={paperSX}>
                  <Typography component="h3" variant="h3" style={heading}>
                    Tus títulos técnicos e informales
                  </Typography>
                  <List
                    dense={dense}
...
export default EducacionTecnica;