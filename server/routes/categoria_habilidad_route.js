...
categoria_habilidad_route.post(
  "/crear-categoria-habilidad",
  Categorias_Habilidad_Controller.Crear_Categoria_Habilidad,
);
categoria_habilidad_route.patch(
  "/actualizar-categoria-habilidad",
  Categorias_Habilidad_Controller.Actualizar_Categoria_Habilidad,
);
