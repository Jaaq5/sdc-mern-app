  ...
  try {
    ...
    if (!usuario) {
      return res.status(409).json({
        success: false,
        error: "Usuario no encontrado al crear bloque",
      });
    }
    ...
    return res.status(200).json({
      success: true,
      msg: "Se ha creado el bloque exitosamente",
...
const Obtener_Bloque = async (req, res) => {
  ...
  try {
    ...
    if (!bloque) {
      return res
        .status(409)
        .json({ success: false, error: "Bloque no encontrado" });
    }

    return res.status(200).json({
      success: true,
      msg: "Se ha encontrado el bloque exitosamente",
      bloque_id: bloque._id,
...
const Actualizar_Bloque = async (req, res) => {
  ...
  try {
    ...
    if (!bloque) {
      return res.status(409).json({
        success: false,
        error: "Usuario no encontrado al buscar bloque de información",
      });
    }
    ...
    return res.status(200).json({
      success: true,
      msg: "Se ha actualizado al bloque exitosamente",
      bloque_id: bloque._id,
    });
  } catch (error) {
    return res
...
const Eliminar_Bloque = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ success: true, msg: "Bloque eliminado correctamente" });
  } catch (error) {
